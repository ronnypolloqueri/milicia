...
ActiveSupport::Inflector.inflections(:en) do |inflect|
  ...
  inflect.uncountable %w( cuartelarmamento cuartel_armamento cuartelvehiculo cuartel_vehiculo personalcurso personal_curso personalinfraccion personal_infraccion alergiapersonal alergia_personal personalalergia personal_alergia armamento armaligera arma_ligera personal region_militar regionmilitar gran_unidad granunidad tipo_armamento tipoarmamento  tipo_vehiculo tipovehiculo unidad )
