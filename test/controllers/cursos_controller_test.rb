...
class CursosControllerTest < ActionController::TestCase
  ...
  test "should create curso" do
    assert_difference('Curso.count') do
      post :create, curso: { descripcion: @curso.descripcion, fecha_fin: @curso.fecha_fin, fecha_inicio: @curso.fecha_inicio, lugar: @curso.lugar, nombre: @curso.nombre }
    end
  ...
  test "should update curso" do
    patch :update, id: @curso, curso: { descripcion: @curso.descripcion, fecha_fin: @curso.fecha_fin, fecha_inicio: @curso.fecha_inicio, lugar: @curso.lugar, nombre: @curso.nombre }
    assert_redirected_to curso_path(assigns(:curso))
  end
