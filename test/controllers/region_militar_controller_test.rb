...
class RegionMilitarControllerTest < ActionController::TestCase
  setup do
    @region_militar = region_militar(:one)
  end

  test "should get index" do
    get :index
    assert_response :success
    assert_not_nil assigns(:region_militar)
  end
  ...
  test "should destroy region_militar" do
    ...
    assert_redirected_to region_militar_index_path
  end
end
